     ...
     public override void OnActionReceived(float[] vectorAction)
     {
       if (gamemanager.game_stop_flg == false){
         ...
         if (gamesetflag == false && distanceToTarget < 0.7f){
           AddReward(30.0f);
           Debug.Log("Enemy2の勝ち！ : " + enemy_1.timenow);
           gamesetflag = true;
           // timenow = 0f;
           //EndEpisode();
         }

         if (gamesetflag == false && (enemy_1.gamesetflag == true || enemy_3.gamesetflag == true)){
           AddReward(5.0f);
           gamesetflag = true;
           //EndEpisode();
         }
         ...
         if (this.transform.localPosition.y < 9.0f){
           AddReward(0.01f);
         }

         if (gamesetflag == true && enemy_1.gamesetflag == true && enemy_3.gamesetflag == true){
           EndEpisode();
         }
       }
     }
